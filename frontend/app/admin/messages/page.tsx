...
import {
  ...
  ImageIcon, Paperclip, Smile, MessageCircle, Loader2,
} from "lucide-react";
...
const AdminMessagesInner = () => {
  ...
  const { messages, sendMessage } = useMessages(activeConversationId || undefined);
  ...
  // Handle URL params (conversation= or new=)
  useEffect(() => {
  ...
  return (
    <div className="h-[calc(100vh-9rem)] rounded-2xl border border-border bg-card shadow-soft overflow-hidden">
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-muted/30">
                {messages.length > 0 ? (
                  ...
                  <div className="text-center py-12 text-muted-foreground">
                    <p className="text-sm">Start a conversation with {displayUser.name}</p>
                  </div>
                )}
