...
import { getCategoryIcon, getCategoryGradient, getCategoryImage } from "@/lib/visuals/categoryVisuals";
                    ...
                    <Link href={`/customer/services/${category.slug}`}>
                      <div className="group relative h-72 rounded-3xl overflow-hidden text-left shadow-card hover:shadow-elevated transition-all duration-500 cursor-pointer">
                        ...
                        <div className="absolute inset-0">
                          ...
                          />
                          <div className={`absolute inset-0 bg-gradient-to-t ${gradient} via-transparent from-black/80 to-transparent`} />
                        </div>
